Crime rate analysis of every state in United States

Data Science question:Which state is having highest crime rates and which state is safe to live and predicting the future crime rate for every state?
